;(function ($, window, undefined) {
  ...
  $("#main").orbit({ directionalNav: false });
...
(function($){
  ...
  $("#contact_form").submit(function(){
	    $('#result').empty();
	    $('#result').append('<img src="images/ajax-loader.gif" alt="Sending" id="loading"/>');
	...
	AjaxFormReturn = function(responseHtml)
	{
		$('#loading').fadeOut(500, function() {
			...
			if(responseHtml == '<p class="success">Message Sent. Thank you for your interest.</p>'){
